  ...
  return (
    <div className="p-6 max-w-[1920px] mx-auto space-y-6">
      ...
      {clearResultItems && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4 animate-fade-in">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full overflow-hidden max-h-[90vh] flex flex-col">
            <div className="bg-emerald-600 p-6 flex flex-col items-center justify-center text-white shrink-0">
              <ShieldCheck className="w-12 h-12 mb-2" strokeWidth={1.5} />
              <h2 className="text-xl font-bold text-center">¡Limpieza Exitosa!</h2>
            </div>
            <div className="p-6 overflow-y-auto">
              <p className="text-sm text-gray-600 mb-4 text-center leading-normal">
              ...
              <div className="bg-emerald-50 p-4 rounded-lg mb-6 border border-emerald-100">
                <ul className="space-y-2">
                  {clearResultItems.map((item, idx) => (
                    <li key={idx} className="flex items-center gap-2 text-sm font-semibold text-emerald-900 bg-white p-2.5 rounded-md border border-emerald-200/60 shadow-sm">
              ...
              <div className="flex pt-2 border-t border-gray-100 mt-2">
                <button
                  ...
                  className="w-full px-4 py-2.5 bg-gray-100 text-gray-700 hover:bg-gray-200 rounded-lg font-bold transition-colors cursor-pointer"
                >
                  Cerrar
                </button>
              </div>
