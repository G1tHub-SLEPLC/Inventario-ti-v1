                ...
                return (
                  <tr key={lic.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="w-14 h-14 rounded shadow-sm border border-gray-100 overflow-hidden bg-white flex items-center justify-center relative group">
                        <img 
                    ...
                    <td className="px-6 py-4 text-center">
                      <div className="flex flex-col items-center gap-1.5">
                        ...
                        {(() => {
                          ...
                          if (diffDays > 0) {
                            return <span className={`px-2 py-0.5 rounded text-[8px] font-semibold uppercase border w-full ${diffDays <= 30 ? 'bg-amber-50 text-amber-700 border-amber-200' : 'bg-blue-50 text-blue-700 border-blue-200'}`}>Quedan {diffDays} días</span>;
                          } else if (diffDays === 0) {
                            return <span className="px-2 py-0.5 rounded text-[8px] font-semibold uppercase border bg-rose-50 text-rose-700 border-rose-200 w-full">Vence Hoy</span>;
                          } else {
                            return <span className="px-2 py-0.5 rounded text-[8px] font-semibold uppercase border bg-red-100 text-red-800 border-red-300 w-full">Vencida hace {Math.abs(diffDays)} días</span>;
                          }
                        })()}
                      </div>
                    </td>
