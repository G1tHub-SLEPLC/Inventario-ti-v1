...
const SLEP_NAV_ITEMS = [
  { to: '/slep/dashboard',  icon: Monitor,         label: 'Mis Equipos', desc: 'Revisar tus equipos asignados y solicitar insumos' },
...
export default function AppShell() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 font-sans overflow-hidden">
      ...
      {toast && (
        <div className={`fixed bottom-5 right-5 z-50 flex items-center gap-3 px-4 py-3 rounded-xl shadow-2xl border max-w-md animate-slide-in text-sm transition-all duration-300 ${
